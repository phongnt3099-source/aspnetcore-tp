...
using ThienPhucDental.MultiTenancy.HostDashboard;
...
namespace ThienPhucDental.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(ThienPhucDentalDbContext context, SubscriptionPayment subscriptionPayment)
        {
