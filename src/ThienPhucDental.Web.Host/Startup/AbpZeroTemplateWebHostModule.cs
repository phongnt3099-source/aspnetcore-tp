...
using ThienPhucDental.Authorization.Users.Password;
...
using ThienPhucDental.Web.Startup.ExternalLoginInfoProviders;
...
namespace ThienPhucDental.Web.Startup
{
    ...
    public class ThienPhucDentalWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public ThienPhucDentalWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(ThienPhucDentalWebHostModule).GetAssembly());
        }
