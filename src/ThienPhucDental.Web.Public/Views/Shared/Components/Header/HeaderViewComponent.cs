...
using ThienPhucDental.Web.Public.Startup;
using ThienPhucDental.Web.Session;
using ThienPhucDental.Web.UiCustomization;

namespace ThienPhucDental.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : ThienPhucDentalViewComponent
    {
