...
using ThienPhucDental.Web.OpenIddict.Claims;
using ThienPhucDental.Web.OpenIddict.ViewModels.Authorize;
using OpenIddict.Abstractions;
using OpenIddict.Server.AspNetCore;

namespace ThienPhucDental.Web.OpenIddict.Controllers
{
