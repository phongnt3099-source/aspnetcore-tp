...
using ThienPhucDental.Authorization.Accounts.Dto;
...
namespace ThienPhucDental.Web.Controllers
{
    ...
    public class TokenAuthController : ThienPhucDentalControllerBase
    {
        ...
        private async Task<string> EncryptQueryParameters(long userId, Tenant tenant, string passwordResetCode)
        {
            ...
            var expireDate = Uri.EscapeDataString(Clock.Now.AddHours(expirationHours)
                .ToString(ThienPhucDentalConsts.DateTimeOffsetFormat));
