...
/// </summary>
public static class ThienPhucDentalJwtBearerExtensions
{
    /// <summary>
    ...
    public static AuthenticationBuilder AddAbpAsyncJwtBearer(this AuthenticationBuilder builder, string authenticationScheme, string? displayName, Action<AsyncJwtBearerOptions> configureOptions)
    {
        ...
        return builder.AddScheme<AsyncJwtBearerOptions, ThienPhucDentalAsyncJwtBearerHandler>(authenticationScheme, displayName, configureOptions);
    }
}
