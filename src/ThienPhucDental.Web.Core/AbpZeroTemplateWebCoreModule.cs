...
using ThienPhucDental.Web.Authentication.JwtBearer;
using ThienPhucDental.Web.Authentication.TwoFactor;
using ThienPhucDental.Web.Chat.SignalR;
using ThienPhucDental.Web.Common;
using ThienPhucDental.Web.Configuration;
using ThienPhucDental.Web.DashboardCustomization;
...
namespace ThienPhucDental.Web
{
    ...
    public class ThienPhucDentalWebCoreModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public ThienPhucDentalWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(ThienPhucDentalWebCoreModule).GetAssembly());
        }
        ...
        public override void PostInitialize()
        {
            ...
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(ThienPhucDentalWebCoreModule).Assembly);
        }
