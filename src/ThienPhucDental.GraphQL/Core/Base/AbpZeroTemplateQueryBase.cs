...
namespace ThienPhucDental.Core.Base
{
    public abstract class ThienPhucDentalQueryBase<TField,TResult> : ITransientDependency
    {
        ...
        protected ThienPhucDentalQueryBase(string fieldName,
