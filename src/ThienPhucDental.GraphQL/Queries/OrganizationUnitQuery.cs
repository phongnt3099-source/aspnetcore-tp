...
using ThienPhucDental.Core.Base;
using ThienPhucDental.Core.Extensions;
using ThienPhucDental.Dto;
using ThienPhucDental.Types;

namespace ThienPhucDental.Queries
{
    public class OrganizationUnitQuery : ThienPhucDentalQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
