...
using ThienPhucDental.Organizations;

namespace ThienPhucDental.Notifications
{
    [AbpAuthorize]
    public class NotificationAppService : ThienPhucDentalAppServiceBase, INotificationAppService
    {
