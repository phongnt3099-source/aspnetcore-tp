...
{
    public class SessionAppService : ThienPhucDentalAppServiceBase, ISessionAppService
    {
            ...
            return await _unitOfWorkManager.WithUnitOfWorkAsync(async () =>
            {
                var output = new GetCurrentLoginInformationsOutput
                {
                    Application = new ApplicationInfoDto
                    {
                        ...
                        Currency = ThienPhucDentalConsts.Currency,
                        CurrencySign = ThienPhucDentalConsts.CurrencySign,
                        AllowTenantsToChangeEmailSettings = ThienPhucDentalConsts.AllowTenantsToChangeEmailSettings,
