...
{
    public class SubscriptionAppService : ThienPhucDentalAppServiceBase, ISubscriptionAppService
    {
        ...
        {
            return upgradeAmount < ThienPhucDentalConsts.MinimumUpgradePaymentAmount;
        }
