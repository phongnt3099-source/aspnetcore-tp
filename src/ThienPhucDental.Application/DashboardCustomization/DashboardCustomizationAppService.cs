...
using ThienPhucDental.DashboardCustomization.Dto;

namespace ThienPhucDental.DashboardCustomization
{
    [AbpAuthorize]
    public class DashboardCustomizationAppService : ThienPhucDentalAppServiceBase, IDashboardCustomizationAppService
    {
