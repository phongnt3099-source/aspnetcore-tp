...
namespace ThienPhucDental.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : ThienPhucDentalAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<ThienPhucDentalDbContext> _migrator;
        ...
        {
            var connectionString = _appConfiguration[$"ConnectionStrings:{ThienPhucDentalConsts.ConnectionStringName}"];
        ...
        {
            EditAppSettingsjson($"ConnectionStrings:{ThienPhucDentalConsts.ConnectionStringName}", constring);
        }
