...
using ThienPhucDental.Authorization.Users.Profile.Cache;
using ThienPhucDental.Authorization.Users.Profile.Dto;
using ThienPhucDental.Configuration;
using ThienPhucDental.Friendships;
using ThienPhucDental.Gdpr;
using ThienPhucDental.Net.Sms;
using ThienPhucDental.Security;
using ThienPhucDental.Storage;
using ThienPhucDental.Timing;
using ThienPhucDental.Url;

namespace ThienPhucDental.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : ThienPhucDentalAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("ThienPhucDental",
