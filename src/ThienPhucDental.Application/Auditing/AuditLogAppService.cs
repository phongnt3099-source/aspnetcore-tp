...
using ThienPhucDental.Auditing.Exporting;
...
using EntityHistoryHelper = ThienPhucDental.EntityHistory.EntityHistoryHelper;

namespace ThienPhucDental.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : ThienPhucDentalAppServiceBase, IAuditLogAppService
    {
