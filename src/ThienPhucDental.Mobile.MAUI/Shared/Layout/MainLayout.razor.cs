...
using AbpZeroTemplate.Services.Navigation;
using Microsoft.AspNetCore.Components;
using AbpZeroTemplate.Mobile.MAUI.Services.Account;
using AbpZeroTemplate.Mobile.MAUI.Services.UI;
using Microsoft.JSInterop;
using AbpZeroTemplate.Mobile.MAUI.Services.Tenants;
using AbpZeroTemplate.Mobile.MAUI.Helpers;

#if ANDROID
using AbpZeroTemplate.Mobile.MAUI.Platforms.Android.HttpClient;
#endif
...
#elif IOS
            var abpHttpClientFactory = new AbpZeroTemplate.Mobile.MAUI.Platforms.iOS.iOSHttpClientFactory
            {
                OnSessionTimeOut = App.OnSessionTimeout,
                OnAccessTokenRefresh = App.OnAccessTokenRefresh
            };
