...
using AbpZeroTemplate.Services.Account;

namespace AbpZeroTemplate.Mobile.MAUI.Pages.Login
{
    public partial class SendTwoFactorCode : AbpZeroTemplateComponentBase
    {
