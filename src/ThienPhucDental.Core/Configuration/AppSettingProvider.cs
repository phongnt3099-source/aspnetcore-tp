...
using ThienPhucDental.Authentication;
using ThienPhucDental.DashboardCustomization;
...
namespace ThienPhucDental.Configuration
{
    ...
    public class AppSettingProvider : SettingProvider
    {
        ...
        {
            if (!ThienPhucDentalConsts.AllowTenantsToChangeEmailSettings)
            {
            ...
            return new[]
            {
                ...
                new SettingDefinition(AppSettings.Email.UseHostDefaultEmailSettings,
                    GetFromAppSettings(AppSettings.Email.UseHostDefaultEmailSettings,
                        ThienPhucDentalConsts.MultiTenancyEnabled ? "true" : "false"), scopes: SettingScopes.Tenant)
            };
        }
        ...
        private IEnumerable<SettingDefinition> GetDashboardSettings()
        {
            ...
            return new[]
            {
                new SettingDefinition(
                    GetSettingName(
                        ThienPhucDentalDashboardCustomizationConsts.Applications.Mvc,
                ...
                new SettingDefinition(
                    GetSettingName(
                        ThienPhucDentalDashboardCustomizationConsts.Applications.Angular,
        ...
        public Dashboard GetDefaultMvcHostDashboardView()
        {
            ...
            {
                DashboardName = ThienPhucDentalDashboardCustomizationConsts.DashboardNames.DefaultHostDashboard,
                Pages = new List<Page>
                {
                    new Page($"Page_{ThienPhucDentalDashboardCustomizationConsts.DashboardNames.DefaultHostDashboard}_{ThienPhucDentalDashboardCustomizationConsts.DefaultPageUniqueName}_{1}")
                    {
                        Name = ThienPhucDentalDashboardCustomizationConsts.DefaultPageName,
                        Widgets = new List<Widget>
                        {
                            new Widget
                            {
                                WidgetId = ThienPhucDentalDashboardCustomizationConsts.Widgets.Host
                                    .TopStats, // Top Stats
                                Height = 6,
                                Width = 12,
                                PositionX = 0,
                            ...
                            {
                                WidgetId =
                                    ThienPhucDentalDashboardCustomizationConsts.Widgets.Host
        ...
        public Dashboard GetDefaultMvcTenantDashboardView()
        {
            ...
            return new Dashboard
            {
                DashboardName = ThienPhucDentalDashboardCustomizationConsts.DashboardNames.DefaultTenantDashboard,
                Pages = new List<Page>
                {
                    new Page($"Page_{ThienPhucDentalDashboardCustomizationConsts.DashboardNames.DefaultTenantDashboard}_{ThienPhucDentalDashboardCustomizationConsts.DefaultPageUniqueName}_{1}")
                    {
                        Name = ThienPhucDentalDashboardCustomizationConsts.DefaultPageName,
                        Widgets = new List<Widget>
                        {
                            new Widget
                            {
                                WidgetId = ThienPhucDentalDashboardCustomizationConsts.Widgets.Tenant
                            ...
                            {
                                WidgetId =
                                    ThienPhucDentalDashboardCustomizationConsts.Widgets.Tenant
