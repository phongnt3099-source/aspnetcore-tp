...
{
    public class ThienPhucDentalMailKitSmtpBuilder : DefaultMailKitSmtpBuilder
    {
        private readonly ILocalizationManager _localizationManager;
        private readonly IEmailSettingsChecker _emailSettingsChecker;
        
        public ThienPhucDentalMailKitSmtpBuilder(
        ...
        {
            return _localizationManager.GetString(ThienPhucDentalConsts.LocalizationSourceName, name);
        }
    }
}