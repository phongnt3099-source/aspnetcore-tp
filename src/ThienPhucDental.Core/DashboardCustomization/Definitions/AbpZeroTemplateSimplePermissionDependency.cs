...
/// </summary>
public class ThienPhucDentalSimplePermissionDependency : IPermissionDependency
{
    /// <summary>
    ...
    /// </summary>
    public ThienPhucDentalSimplePermissionDependency()
    {
    ...
    public ThienPhucDentalSimplePermissionDependency(params string[] permissions)
    {
    ...
    /// </param>
    /// <param name="permissions">The permissions.</param>
    public ThienPhucDentalSimplePermissionDependency(bool requiresAll, params string[] permissions)
        : this(permissions)
    {
