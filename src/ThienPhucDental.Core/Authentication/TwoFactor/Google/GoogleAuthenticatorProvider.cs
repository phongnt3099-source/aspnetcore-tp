...
namespace ThienPhucDental.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : ThienPhucDentalServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("ThienPhucDental", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
