...
using ThienPhucDental.Authorization.Delegation;
using ThienPhucDental.Authorization.Ldap;
...
using ThienPhucDental.DashboardCustomization.Definitions;
using ThienPhucDental.Debugging;
using ThienPhucDental.DynamicEntityProperties;
using ThienPhucDental.Features;
using ThienPhucDental.Friendships;
using ThienPhucDental.Friendships.Cache;
...
using ThienPhucDental.WebHooks;

namespace ThienPhucDental
{
    [DependsOn(
        typeof(ThienPhucDentalCoreSharedModule),
        typeof(AbpZeroCoreModule),
        typeof(AbpZeroLdapModule),
        typeof(AbpAutoMapperModule),
        typeof(AbpAspNetZeroCoreModule),
        typeof(AbpMailKitModule))]
    public class ThienPhucDentalCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            ThienPhucDentalLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.MultiTenancy.IsEnabled = ThienPhucDentalConsts.MultiTenancyEnabled;
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, ThienPhucDentalMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<ThienPhucDentalSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(ThienPhucDentalCoreModule).GetAssembly());
        }
