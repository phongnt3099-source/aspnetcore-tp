...
using ThienPhucDental.MultiTenancy.Accounting;
...
{
    public class ThienPhucDentalDbContext : AbpZeroDbContext<Tenant, Role, User, ThienPhucDentalDbContext>, IOpenIddictDbContext
    {
        ...
        public ThienPhucDentalDbContext(DbContextOptions<ThienPhucDentalDbContext> options)
            : base(options)
        {
        }
