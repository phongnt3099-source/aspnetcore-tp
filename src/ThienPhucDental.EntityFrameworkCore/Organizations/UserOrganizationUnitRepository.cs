...
using ThienPhucDental.EntityFrameworkCore.Repositories;

namespace ThienPhucDental.Organizations
{
    public class UserOrganizationUnitRepository : ThienPhucDentalRepositoryBase<UserOrganizationUnit, long>,
        IUserOrganizationUnitRepository
    {
        public UserOrganizationUnitRepository(IDbContextProvider<ThienPhucDentalDbContext> dbContextProvider)
