...
{
    public class SubscriptionPaymentRepository : ThienPhucDentalRepositoryBase<SubscriptionPayment, long>,
        ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<ThienPhucDentalDbContext> dbContextProvider)
