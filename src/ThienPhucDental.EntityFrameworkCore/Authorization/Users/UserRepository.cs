...
{
    public class UserRepository : ThienPhucDentalRepositoryBase<User, long>, IUserRepository
    {
        public UserRepository(IDbContextProvider<ThienPhucDentalDbContext> dbContextProvider)
