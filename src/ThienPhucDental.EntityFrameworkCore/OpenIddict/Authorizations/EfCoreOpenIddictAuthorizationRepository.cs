...
namespace ThienPhucDental.OpenIddict.Authorizations
{
    public class EfCoreOpenIddictAuthorizationRepository : ThienPhucDentalRepositoryBase<OpenIddictAuthorization, Guid>,
