...
namespace ThienPhucDental.OpenIddict.Applications
{
    public class EfCoreOpenIddictApplicationRepository : ThienPhucDentalRepositoryBase<OpenIddictApplication, Guid>,
